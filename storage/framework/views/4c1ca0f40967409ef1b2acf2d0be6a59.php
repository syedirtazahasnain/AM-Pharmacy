                        ...
                        <div>
                            ...
                            <select name="customer_id" required class="mt-1 block w-full rounded-md border-gray-300">
                                ...
                                <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($customer->id); ?>"><?php echo e($customer->customer_number); ?> -
                                        <?php echo e($customer->name); ?> (<?php echo e($customer->district); ?>)</option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\pharmacy-app\resources\views/invoices/create.blade.php ENDPATH**/ ?>